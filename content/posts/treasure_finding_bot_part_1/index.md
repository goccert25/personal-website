---
title: "Building a Treasure Finding Bot (Part 1)"
date: 2020-07-19
author: "George Tong"
description: "How I scraped 2.3 million sold listings from Grailed using Selenium and regex to build a treasure finding bot."
tags:
  - grailed
  - secondhand
  - scraping
...
Query and find the [most expensive thing](https://www.grailed.com/listings/5287098-raf-simons-aw-2001-riot-riot-riot-patched-bomber) ever sold on Grailed:
...
Query the [most expensive underwear](https://www.grailed.com/listings/2316802-versace-versace-baroque-gold-crown-animal-print-100--silk-boxers-size-6--495-sale) purchased:
...
I still had to make the rest of the tracker, and was faced with a couple of issues. How would I determine what was or wasn't good deal? No two listings are the same, with varying titles, conditions, item types, yearly styles, etc. In [part 2]({{< ref "/posts/treasure_finding_bot_part_2" >}}), I detail how I tackled these problems while building the rest of the treasure finding bot.

*August 2nd, 2020 update*: a friend [Rex](https://rexledesma.com/) pointed out I could have actually recorded the network traffic when Grailed loaded new items and reverse engineered the actual API, which would have cut back on even MORE time. This might have been doable in 10-20 minutes! You always learn something new everyday.
